...
const Chat = () => {
    ...
    const sendMessage = async (e) => {
        ...
        if (!input.trim()) {
            console.log('Строка пустая или состоит только из пробелов')
            return
        }
    ...
    return (
        <div className="chat">
            <div className="chat__header">
                ...
                <h3 className="chat__header-title">{roomName}</h3>
                <span className='chat__header-time'>
                    last active {new Date(
                        mssg[mssg.length - 1]?.timestamp?.toDate()
                ...
                {mssg.map((message) => (
                    ...
                    >
                        ...
                        <div className="chat__mssg-body">
                            <p className="chat__mssg-text">{message.message}</p>
